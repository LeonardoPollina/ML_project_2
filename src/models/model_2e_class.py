...
class MODEL_CLASS:
    ...
    def __init__(self):
        ...
        #Other stuff
        self.NameWeights = 'model_2e_1612_Weights'
        self.SubmissionName = 'model_2e_1612_Submission.csv'
        self.PredictionName = 'model_2e_1612_prediction'
    ...
    def CreateModel(self):     
        ...
        model.add(Dense(128, activation = 'relu', kernel_regularizer = l2(self.reg))) 
        model.add(Dropout(0.5))  
