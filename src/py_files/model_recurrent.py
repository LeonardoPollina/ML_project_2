...
#Other stuff
NameWeights = 'Recurrent_model_weights1212'
SubmissionName = 'Recurrent_Submission1212.csv'
...
def create_model():    
    ...
    xl = Convolution2D(64, (5,5), 
                            padding = 'SAME', activation = 'relu',
                            kernel_initializer = K_init.RandomUniform(minval=-0.05, maxval=0.05, seed=1)
                            )                  (x0)
    xl = MaxPooling2D((2, 2), strides=(2, 2))  (xl)
    xl = Convolution2D(64, (3,3),
                            padding = 'SAME', activation = 'relu',
                            kernel_initializer = K_init.RandomUniform(minval=-0.05, maxval=0.05, seed=1)
                           )                   (xl)
    xl = MaxPooling2D((2, 2), strides=(2, 2))  (xl)
    ...
    concat = Dense(512, activation = 'relu', kernel_regularizer = l2(reg)) (concat)
